  ...
  return (
    <div>
      ...
      <p className="mt-1 text-ink-900/60">
        Horario general de entrenamiento visible en el sitio público.
      </p>
          ...
          <tbody>
            {sorted.map((s) => (
              <tr key={s.id} className="border-t border-ink-900/5">
                <td className="px-4 py-3 font-semibold text-ink-900">{DAY_LABELS[s.day_of_week] ?? s.day_of_week}</td>
